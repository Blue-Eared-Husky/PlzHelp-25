...
function keyPressed() {
  ...
  if(keyCode === 32){
    ...
    var new_arrow = new PlayerArrow(pos.x,pos.y,100,10);

    var arrow_trajectory = [];
    Matter.Body.setAngle(new_arrow.body, angle);
    playerArrows.push(new_arrow);
  }
}
...
function keyReleased () {
  ...
  if(keyCode === 32){
    ...
    for (var i = 0; i < playerArrows.length; i++){
      playerArrows[i].shoot(playerArcher.angle);
    }
  }
